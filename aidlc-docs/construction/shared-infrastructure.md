...
| U2 Homepage Publication Boundary | C06~C10, S02/S03; homepage/post projection and generated static contract | Later confirm that `/`, removed normal-post exposure and approved generated/discovery outputs remain deliverable through the same origin/default behavior; record no change or stop | Exact U2 keys before its design, copied profile ownership, new delivery resources or U3 verification behavior |
